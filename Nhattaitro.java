 ...
 * @author Anh Duy
 */
public class Nhattaitro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã nhà TT", "Tên nhà tài trợ", "Chi Phí"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jLabel2.setText("Nhà Tài Trợ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nhattaitro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Nhattaitro().setVisible(true);
            }
        });
    }
